...
export default function HeroSection() {
  return (
    <section className="relative overflow-hidden bg-gradient-to-b from-slate-900 via-slate-800 to-slate-900 py-20 lg:py-32">
      ...
      <div
        className="absolute top-1/3 left-16 animate-float"
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-center lg:text-right space-y-8">
            <div className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full bg-amber-400/20 border border-amber-400/30 text-amber-400 text-sm font-medium backdrop-blur-sm">
              ...
              <span>
                پذیرش پیش‌یک و پیش‌دو برای کودکان ۳ تا ۷ سال (مختلط)
              </span>
            </div>

            <h1 className="text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold leading-tight">
              <span className="text-white">کودکستان روما</span>
              <br />
              <span className="text-amber-400">
                محیطی امن، شاد و یادگیرنده
              </span>
              <br />
              <span className="text-white">برای رشد همه‌جانبه کودکان</span>
            </h1>

            <p className="text-xl text-slate-300 max-w-lg mx-auto lg:mx-0 leading-relaxed">
              در کودکستان روما، با تکیه بر کادری مجرب و برنامه‌های آموزشی
              استاندارد، کودکان ۳ تا ۷ سال در پایه‌های پیش‌یک و پیش‌دو، مهارت‌های
              تحصیلی، اجتماعی و زندگی را در قالب بازی، تجربه و کلاس‌های تخصصی
              می‌آموزند.
            </p>
            ...
            <div className="flex flex-wrap gap-10 justify-center lg:justify-start pt-8">
              <div className="text-center">
                <div className="text-4xl font-bold text-amber-400">۳–۷</div>
                <div className="text-sm text-slate-400 mt-1">
                  گروه سنی پذیرش
                </div>
              </div>
              <div className="text-center">
                <div className="text-4xl font-bold text-amber-400">۲</div>
                <div className="text-sm text-slate-400 mt-1">
                  پایه‌های پیش‌یک و پیش‌دو
                </div>
              </div>
              <div className="text-center">
                <div className="text-4xl font-bold text-amber-400">۸+</div>
                <div className="text-sm text-slate-400 mt-1">
          ...
          <div className="relative hidden lg:block">
            <div className="relative z-10 rounded-3xl overflow-hidden shadow-2xl shadow-amber-400/20">
              <img
                ...
                alt="کودکان در محیط شاد و ایمن کودکستان روما"
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <div className="font-bold text-white">
                    محیطی ایمن و استاندارد
                  </div>
                  <div className="text-sm text-slate-300">
                    پایه‌های پیش‌یک و پیش‌دو با برنامه‌های روزآمد و بازی‌محور
                  </div>
                </div>
              </div>
            </div>
